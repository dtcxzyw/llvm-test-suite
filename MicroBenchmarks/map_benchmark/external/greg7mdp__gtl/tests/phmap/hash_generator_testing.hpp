...
#ifndef GTL_PRIV_HASH_GENERATOR_TESTING_H_
#define GTL_PRIV_HASH_GENERATOR_TESTING_H_
...
namespace std
{
    ...
    using gtl::priv::hash_internal::Enum;
...
#endif  // GTL_PRIV_HASH_GENERATOR_TESTING_H_
